exports.on = async ( msg, { command }) => {
const name = ["ISLAM"];  
const tag = ["mandiwajib"];
const help = ["mandiwajib"]
...
Baca juga:
Doa setelah Mandi Wajib untuk Pria seusai Berhubungan Suami Istri
Baca juga:
Bacaan Niat Mandi Wajib bagi Laki-laki dan Perempuan Beserta Artinya
...
`
conn.sendMessage(msg.chat, { text: mandiwajib }, { quoted: msg });
  }
}