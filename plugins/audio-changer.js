...
exports.on = async ( msg, { conn, command, mess, isQuotedAudio, getRandom }) => {
const name = ["AUDIO"];  
...
conn.sendMessage(msg.chat, { audio: buff, mimetype: 'audio/mpeg' }, { quoted : msg })
})
} else {
msg.reply(`Balas audio yang ingin diubah dengan caption *#${command}*`)
}
}
if (command === 'blown') {
if (isQuotedAudio){
